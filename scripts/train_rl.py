...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--proposal-weight-decay", type=float, default=0.0)
    parser.add_argument("--proposal-weight-temperature", type=float, default=1.0)
    parser.add_argument("--proposal-entropy-weight", type=float, default=0.01)
    parser.add_argument("--proposal-grad-clip-norm", type=float, default=None)
